 ...
 */
router.post('/register', auth_middleware_1.authenticate, (0, rbac_middleware_1.authorizeRoles)('ADMIN'), (0, validate_middleware_1.validate)(auth_validator_1.registerSchema), authController.register);
/**
 * POST /api/auth/login
